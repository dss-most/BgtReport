...
@Service
public class BgtHasPcmListExcelView extends AbstractPOIExcelView {
	private static final Logger logger = LoggerFactory.getLogger(BgtHasPcmListExcelView.class);
	...
	protected void buildExcelDocument(Map<String, Object> model,
		...
		List<Map <String,Object>> list = (List<Map <String,Object>>) model.get("bgtHasPcmList");
		...
		firstCell.setCellValue("รายการเบิกจ่ายตาม BGT ที่มีวศ. 22 ปีงบประมาณ " + fiscalYear);
